...
alt.onServer("onKill", (team1, team2) => {
...
alt.onServer("onKillLog", (killerName, victimName, killerTeam, victimTeam, weapon, isHeadshot) => {
...
alt.onServer("lobby:Ended", (winner) => {
...
alt.onServer("showPoint", (point, pos) => {
